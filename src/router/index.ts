          ...
          children: [
            {
              ...
              beforeEnter(from, to, next) {
                ...
                const param = <string>(to.params.artworkId ?? from.params.artworkId)
                if (param !== 'new') {
                  const id = parseInt(<string>(to.params.artworkId ?? from.params.artworkId))
                  artworkStore.loadArtwork(id)
                }
                next()
              }
            }
          ...
          children: [
            {
              ...
              beforeEnter(from, to, next) {
                ...
                if (param !== 'new') {
                  const id = parseInt(<string>(to.params.slotId ?? from.params.slotId))
